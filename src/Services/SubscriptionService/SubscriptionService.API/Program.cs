...
using SubscriptionService.Application.Validation;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "HireConnect - Subscription Service", Version = "v1" });
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Subscription Service v1"));
}
